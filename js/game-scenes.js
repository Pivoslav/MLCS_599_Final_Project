...
Which answer do you hazard aloud?`,
        primaryRead: {
          title: "Read alongside: First Philosophical Letter (Letter I)",
          body: `<strong>Letter I (Byzantium):</strong> “…we proceeded to seek the moral code which was to constitute our education in miserable Byzantium, an object held in profound contempt by these peoples.”<br><span class="read-gloss">Chaadaev attacks where Russia sought moral formation. Slavophile Orthodoxy still owes him a historical answer, not only a counter-slogan.</span><br><br><strong>Letter I (unity and schism):</strong> “…the vivifying principle of unity animated everything.” / “But we were isolated in our schism, and nothing that was happening in Europe reached us.”<br><span class="read-gloss">His idealized Latin Christendom versus Russia’s isolation. The buttons below ask whether parish institutions and budgets bridge that gap, or freezing foreign law only hardens it.</span><br><br><strong>Discuss:</strong> Land, <em>narod</em>, Orthodox conscience, suspicion of abstract “rights” talk (themes later associated with Aksakov). Does this language help the clerk in the flood, or chiefly the idea of the village?<br><span class="read-gloss">First answer: parish schools and elected boards, faith with budgets. Second: freeze foreign-looking law and defend the whole way of life. Both test whether <em>narod</em> talk reaches Pushkin’s clerk or stops at the icon.</span>`
        },
        choices: [
...
<strong>What now?</strong> Appeal in public with reform allies in the capital, or shrink to small charity and keep a shell of the pilot alive for another season?`,
      ...
      resolve_endings: {
        ...
        /** Spend a shared pool across meters before framing choices (`getRealmBudgetPoolPoints()` in game-app.js; 3/5/8 from winter total bands). Runs for every run that reaches this scene (solo or co-op). */
...
<strong>If the table agrees</strong> that Reform should frame how you retell this winter, confirm below; otherwise step back and pick another voice on the previous screen.`,
        primaryRead: {
          title: "Read alongside: First Philosophical Letter (Letter I)",
        ...
        choices: [
          { text: "<strong>You:</strong> “Yes. Tell the story with law, schools, and the work of reform as the moral center.”", next: "ending_computed" }
        ],
        tag: "reform"
      },
