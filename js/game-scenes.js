    const READ_ALONG_EDITION_NOTE =
      '<p class="read-edition-note">For assigned wording use <strong>McNally &amp; Tempest</strong>, <em>Philosophical Works of Peter Chaadaev</em> (Springer, 1991), Letter I; for Pushkin in this unit use your library edition or <strong>Arndt</strong>’s <em>The Bronze Horseman</em> (1993)—citations in <strong>SOURCES.md</strong>.</p>';
