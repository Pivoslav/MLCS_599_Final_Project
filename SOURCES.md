...
## 2) Related course material (Pushkin: *The Gypsies*)

These items informed a **separate** presentation in the wider course; they are **not** embedded in this repo’s game files.
...
3. **Wikipedia**: [The Gypsies (poem)](https://en.wikipedia.org/wiki/The_Gypsies_(poem)) (orientation, publication history, scholarly pointers).
