...
| `mechanic-co-op-timer-ballot.html` | **Shipped:** story-column co-op card (gating + timer), **three seat cards**, then reveal/stance/apply **above** choice buttons. | `wireCoopTools`, `#coopMainBallotWrap`, `#coopToolsActionBar`, `state.coopToolsEnabled`. |
